...
func NewListener(
	...
	resolver *Resolver,
	messages *MessageStore,
	userToken, botToken string, acct account.Account, teamID, pigeonBotUID string,
	onMessage hub.NotifyFunc[modelv1.MsgLine], onReaction hub.NotifyFunc[modelv1.ReactLine], onEdit hub.NotifyFunc[modelv1.EditLine], onDelete hub.NotifyFunc[modelv1.DeleteLine], syncTracker *syncstatus.Tracker) *Listener {
	return &Listener{
		client:       client,
		resolver:     resolver,
		messages:     messages,
