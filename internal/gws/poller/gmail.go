...
func PollGmail(s *store.FSStore, account paths.AccountDir, cursors *store.Cursors) (int, error) {
...
func seedGmail(s *store.FSStore, account paths.AccountDir, cursors *store.Cursors) (int, error) {
