...
//
// Run with: CLAUDE_LIVE_TEST=1 go test ./internal/workstream/claudecli/ -run TestClient_JSON -v
...
//
// Run with: CLAUDE_LIVE_TEST=1 go test ./internal/workstream/claudecli/ -run TestClient_Text -v
